...
class UDAttribute {
    ...
    unit;
    defaultUnit;
    enable; //该属性是否启用(2019年04月29日：一个组件在某些情况下，可能会导致自己的某些属性无法使用，比如在相对定位布局容器下，自己的x,y是无效的。)
    ...
    constructor({
        ...
        // }else{
        this.enable = enable === undefined ? true : enable; //默认情况下，属性是开启的
        this.name = name;
        this.desc = desc;
        this.value = value;
